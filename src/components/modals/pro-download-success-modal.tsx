...
const ProDownloadSuccessModal = () => {
  const { setIsModalOpen, setIsProDownloadSuccessModalOpen } = useModal();

  const handleClose = () => {
    setIsModalOpen(false);
    setIsProDownloadSuccessModalOpen(false);
  };
  return (
...
export default ProDownloadSuccessModal;
